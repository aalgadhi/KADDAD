...
function Profile() {
  ...
  const handleAddPayment = () => {
    ...
    if(!validExp){return;}
    const newMethod={
      type:t,last4:l4,expires:exp,isDefault:false
    };
            ...
            <div className="col-lg-8">
              ...
              <div className="card shadow-sm mb-4">
                <div className="card-header bg-white d-flex justify-content-between align-items-center">
                  ...
                  <button className="btn btn-sm btn-outline-primary" onClick={()=>setShowPaymentModal(true)}>
                  ...
                  {paymentMethods.map((pm,index)=>(
                    <div key={index} className="d-flex justify-content-between align-items-center mb-3 p-2 border rounded">
                      <div className="d-flex align-items-center">
                        ...
                        ></i>
                        <div>
                          <p className="mb-0 fw-bold">{pm.type} ending in {pm.last4}</p>
                      ...
                      <div>
                        ...
                        {!pm.isDefault&&(
                          <button className="btn btn-sm btn-outline-secondary me-2" onClick={()=>handleSetDefault(index)}>
                            Set Default
                          </button>
                        )}
                        <button className="btn btn-sm btn-outline-danger" onClick={()=>handleDeletePayment(index)}>
              ...
              <div className="modal-body">
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    value={newPayLast4}
                    onChange={e=>{
                      if(/^\\d*$/.test(e.target.value)){setNewPayLast4(e.target.value);}
                    }}
                  />
                </div>
                <div className="mb-3">
